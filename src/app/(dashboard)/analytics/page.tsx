    ...
    <ErrorBoundary>
      ...
      {isLoading ? (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="glass-panel h-[120px] animate-pulse rounded-2xl" />
          ))}
        </div>
      ) : (
        <div className="stagger-children grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard
            ...
            accentColor={stats.overdueTasks > 0 ? '#ffffff' : '#3f3f46'}
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <GlassCard padding="lg">
            <h2 className="mb-6 flex items-center gap-2 text-lg font-semibold text-white">
              <ActivityIcon size={20} className="text-white/70" /> Productivity Overview
            </h2>
          ...
          <GlassCard padding="lg">
            <h2 className="mb-6 flex items-center gap-2 text-lg font-semibold text-white">
              <TrendingUpIcon size={20} className="text-white/70" /> Project Progress
            </h2>
        ...
        <div className="space-y-6">
          <GlassCard padding="lg">
            <h2 className="mb-6 flex items-center gap-2 text-lg font-semibold text-white">
              <ActivityIcon size={20} className="text-white/70" /> Recent Activity
            </h2>
            {activityLoading ? (

  ...
  return (
    <div className="mb-8 space-y-4 animate-fade-in-up">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {invites.map((invite) => (
          <GlassCard key={invite.id} padding="md" className="flex flex-col justify-between border-white/20/30">
            ...
            <div className="mt-6 flex items-center justify-end gap-2">
              ...
              <button
                ...
                disabled={loadingId === invite.id}
                className="flex items-center gap-1.5 rounded-full bg-white text-black px-3 py-1.5 text-xs font-medium text-white hover:bg-white text-black disabled:opacity-50 transition-colors"
              >

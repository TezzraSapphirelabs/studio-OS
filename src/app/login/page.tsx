      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="animate-fade-in-up rounded-3xl border border-white/[0.08] bg-white/[0.03] p-8 shadow-2xl backdrop-blur-2xl sm:p-10">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 text-sm text-white placeholder:text-white/25 outline-none transition-all focus:border-violet-500/50 focus:bg-white/[0.06] focus:ring-1 focus:ring-violet-500/25"
              />
            </div>
            <div>
            ...
            <Link
              href="/dashboard"
              className="mt-2 flex h-11 w-full items-center justify-center rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 text-sm font-semibold text-white shadow-lg shadow-violet-600/25 transition-all hover:shadow-violet-600/40 hover:brightness-110 active:scale-[0.98]"
            >
              Sign In
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex h-11 items-center justify-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.03] text-sm font-medium text-white/70 transition-all hover:bg-white/[0.06] hover:text-white">
          ...
          <p className="mt-6 text-center text-xs text-white/25">
            ...
            <span className="font-medium text-violet-400 cursor-pointer hover:text-violet-300 transition-colors">
              Create one
            </span>
          </p>
        </div>
